...
class Reader():
    def __init__(self, ser) -> None:
        ...
        """
        self.ser = ser
        self.monza_r6 = MonzaR6()  # Initialize MonzaR6

    def extract_38_Bit_serial_number(self, binary_TID_data):
        """
        Extracts the 38-bit serial number using MonzaR6.
        """
        return self.monza_r6.extract_38_Bit_serial_number(binary_TID_data)
